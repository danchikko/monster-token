	...
	return (
		<div className={styles.container}>
			...
			<div className={styles.shellInfo}>
				<ul>
					<img className={styles.scan} src={scan} alt='imgScan' /></li>
					<img className={styles.gecko} src={gecko} alt='imgGecko' /></li>
					<img className={styles.tools} src={tools} alt='imgTools' /></li>
					<img className={styles.swap} src={swap} alt='imgSwap' /></li>
					<img className={styles.coin} src={coin} alt='imgCoin' /></li>
				</ul>
			</div>
		</div>
	)
