	...
	return (
		<div className={styles.container}>
			...
			<div className={styles.shellInfo}>
				<ul>
					<li ><img className={styles.scan} src={scan} alt='imgScan' /></li>
					<li ><img className={styles.gecko} src={gecko} alt='imgGecko' /></li>
					<li ><img className={styles.tools} src={tools} alt='imgTools' /></li>
					<li ><img className={styles.swap} src={swap} alt='imgSwap' /></li>
					<li ><img className={styles.coin} src={coin} alt='imgCoin' /></li>
				</ul>
			</div>
		</div>
	)
